          ...
          <div key={rate.pair} className="terminal-panel p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-12 h-8 rounded bg-terminal-border flex items-center justify-center text-xs font-bold">
                  {rate.pair}
                </div>
                <div>
              ...
              {forexRates.map((rate) => (
                <tr key={rate.pair} className="border-b border-terminal-border/50">
                  ...
                  <td className="p-2 text-right">
                    <span className={rate.change >= 0 ? 'text-terminal-accent' : 'text-terminal-danger'}>
